...
from constants import CONFIG_PATH, DEVICE_PATH, SHORT_SN_PATH, INTEGRATION_CONFIG_PATH
...
def read_config(filename: str = CONFIG_PATH) -> Optional[Dict[str, Any]]:
    """
...
async def main() -> int:
    ...
    config = read_config(INTEGRATION_CONFIG_PATH)
    if not config:
